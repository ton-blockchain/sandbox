...
// _ init:(Maybe (Either StateInit ^StateInit)) = EitherStateInit;

export interface EitherStateInit {
    readonly kind: 'EitherStateInit';
    readonly init: Maybe<Either<StateInit, StateInit>>;
}
...
export interface NewBounceOriginalInfo {
    readonly kind: 'NewBounceOriginalInfo';
    readonly value: CurrencyCollection;
    readonly created_lt: bigint;
    readonly created_at: number;
}
...
export interface NewBounceComputePhaseInfo {
    readonly kind: 'NewBounceComputePhaseInfo';
...
export interface NewBounceBody {
    readonly kind: 'NewBounceBody';
    readonly original_body: Cell;
    readonly original_info: NewBounceOriginalInfo;
    readonly bounced_by_phase: number;
    readonly exit_code: number;
    readonly compute_phase: Maybe<NewBounceComputePhaseInfo>;
}
...
// _ ValRegistryConfig = ConfigParam 46;
...
export interface ConfigParam__41 {
    ...
    readonly anon0: ValRegistryConfig;
}
...
export interface ConfigParam__47 {
    readonly kind: 'ConfigParam__47';
    readonly anon0: JettonBridgeParams;
}
...
/*
cfg_vote_cfg#36 min_tot_rounds:(## 8) max_tot_rounds:(## 8) { min_tot_rounds <= max_tot_rounds }
  min_wins:uint8 max_losses:uint8 min_store_sec:(## 32) max_store_sec:(## 32)
  { min_store_sec <= max_store_sec } bit_price:uint32 cell_price:uint32 = ConfigProposalSetup;
*/
...
/*
catchain_config#c1 mc_catchain_lifetime:(## 32) { mc_catchain_lifetime >= 1 }
  shard_catchain_lifetime:(## 32) { shard_catchain_lifetime >= 1 }
  shard_validators_lifetime:(## 32) { shard_validators_lifetime >= 1 }
  shard_validators_num:(## 32) { shard_validators_num >= 1 } = CatchainConfig;
*/

/*
catchain_config_new#c2 flags:(## 7) { flags = 0 } shuffle_mc_validators:Bool
  mc_catchain_lifetime:(## 32) { mc_catchain_lifetime >= 1 }
  shard_catchain_lifetime:(## 32) { shard_catchain_lifetime >= 1 }
  shard_validators_lifetime:(## 32) { shard_validators_lifetime >= 1 }
  shard_validators_num:(## 32) { shard_validators_num >= 1 } = CatchainConfig;
*/
...
/*
size_limits_config_v3#03 max_msg_bits:uint32 max_msg_cells:uint32 max_library_cells:uint32 max_vm_data_depth:uint16
  max_ext_msg_size:uint32 max_ext_msg_depth:uint16 max_acc_state_cells:uint32 max_mc_acc_state_cells:uint32
  max_acc_public_libraries:uint32 defer_out_queue_size_limit:uint32 max_msg_extra_currencies:uint32
  max_acc_fixed_prefix_length:uint8 acc_state_cells_for_storage_dict:uint32
  max_transaction_library_loads:(Maybe uint32)
  max_total_msg_bits:uint32 max_total_msg_cells:uint32 = SizeLimitsConfig;
*/

export type SizeLimitsConfig = SizeLimitsConfig_size_limits_config | SizeLimitsConfig_size_limits_config_v2 | SizeLimitsConfig_size_limits_config_v3;
...
export interface SizeLimitsConfig_size_limits_config_v3 {
    readonly kind: 'SizeLimitsConfig_size_limits_config_v3';
    readonly max_msg_bits: number;
    readonly max_msg_cells: number;
    readonly max_library_cells: number;
    readonly max_vm_data_depth: number;
    ...
    readonly acc_state_cells_for_storage_dict: number;
    readonly max_transaction_library_loads: Maybe<number>;
    readonly max_total_msg_bits: number;
    readonly max_total_msg_cells: number;
}
...
export type BlockSignatures = BlockSignatures_block_signatures_ordinary | BlockSignatures_block_signatures_simplex;

export interface BlockSignatures_block_signatures_ordinary {
    readonly kind: 'BlockSignatures_block_signatures_ordinary';
    readonly validator_list_hash_short: number;
    readonly catchain_seqno: number;
...
export interface BlockSignatures_block_signatures_simplex {
    readonly kind: 'BlockSignatures_block_signatures_simplex';
    readonly validator_list_hash_short: number;
    readonly catchain_seqno: number;
    readonly sig_count: number;
    readonly sig_weight: bigint;
...
export interface AccountStorageDictProof {
    readonly kind: 'AccountStorageDictProof';
    readonly proof: Cell;
}

// consensus_extra_data#638eb292 flags:# gen_utime_ms:uint64 = ConsensusExtraData;

export interface ConsensusExtraData {
    readonly kind: 'ConsensusExtraData';
    readonly flags: number;
    readonly gen_utime_ms: bigint;
}
...
// val_registry_config#3601163e contract_address:bits256 max_collators_per_validator:uint32 new_code_hash:(Maybe uint256) = ValRegistryConfig;

export interface ValRegistryConfig {
    readonly kind: 'ValRegistryConfig';
    readonly contract_address: Buffer;
    readonly max_collators_per_validator: number;
    readonly new_code_hash: Maybe<bigint>;
}

// _ x:(## 1) = BitsPow2 0;

// _ {n:#} l:(BitsPow2 n) r:(BitsPow2 n) = BitsPow2 (n + 1);

export type BitsPow2 = BitsPow2__ | BitsPow2__1;

export interface BitsPow2__ {
    readonly kind: 'BitsPow2__';
    readonly x: number;
}

export interface BitsPow2__1 {
    readonly kind: 'BitsPow2__1';
    readonly n: number;
    readonly l: BitsPow2;
    readonly r: BitsPow2;
}
...
export interface ValRegistryShardSet {
    readonly kind: 'ValRegistryShardSet';
    readonly n: number;
    readonly mask: BitsPow2;
}

// val_registry_storage#9bc722a8 registry:(HashmapE 256 ValRegistryValidator) last_cleanup_key_block_seqno:uint32 = ValRegistryStorage;

export interface ValRegistryStorage {
    readonly kind: 'ValRegistryStorage';
    readonly registry: Dictionary<bigint, ValRegistryValidator>;
    readonly last_cleanup_key_block_seqno: number;
}

// val_registry_validator#57766eec allow_update_at:uint32 entry:(Maybe ^ValRegistryEntry) = ValRegistryValidator;

export interface ValRegistryValidator {
    readonly kind: 'ValRegistryValidator';
    readonly allow_update_at: number;
    readonly entry: Maybe<ValRegistryEntry>;
}

// val_registry_entry#eae0b274 collators:(HashmapE 256 ValRegistryCollator) monitoring_shards:ValRegistryShardSet = ValRegistryEntry;

export interface ValRegistryEntry {
    readonly kind: 'ValRegistryEntry';
    readonly collators: Dictionary<bigint, ValRegistryCollator>;
    readonly monitoring_shards: ValRegistryShardSet;
}

// val_registry_collator#10364494 monitoring_shards:ValRegistryShardSet = ValRegistryCollator;

export interface ValRegistryCollator {
    readonly kind: 'ValRegistryCollator';
    readonly monitoring_shards: ValRegistryShardSet;
}

// val_registry_message_request#cdb9d286 signature:(512 * Bit) request:ValRegistryRequest = ValRegistryMessageRequest;

export interface ValRegistryMessageRequest {
    readonly kind: 'ValRegistryMessageRequest';
    readonly signature: Array<boolean>;
    readonly request: ValRegistryRequest;
}

/*
val_registry_request_update#fbd82b02 last_key_block_seqno:uint32 val_set:uint8 val_idx:uint16 valid_until:uint32
    new_entry:(Maybe ^ValRegistryEntry) = ValRegistryRequest;
*/

export interface ValRegistryRequest {
    readonly kind: 'ValRegistryRequest';
    readonly last_key_block_seqno: number;
    readonly val_set: number;
    readonly val_idx: number;
    readonly valid_until: number;
    readonly new_entry: Maybe<ValRegistryEntry>;
}

// val_registry_message_cleanup#32b85a9b = ValRegistryMessageCleanup;

export interface ValRegistryMessageCleanup {
    readonly kind: 'ValRegistryMessageCleanup';
}

// val_registry_message_update_code#34bdaa6c new_code:^Cell = ValRegistryMessageUpdateCode;

export interface ValRegistryMessageUpdateCode {
    readonly kind: 'ValRegistryMessageUpdateCode';
    readonly new_code: Cell;
}
...
export function loadCommonMsgInfo(slice: Slice): CommonMsgInfo {
    if (((slice.remainingBits >= 1) && (slice.preloadUint(1) == 0b0))) {
        ...
        let extra_flags: bigint = slice.loadVarUintBig(bitLen((16 - 1)));
...
export function storeCommonMsgInfo(commonMsgInfo: CommonMsgInfo): (builder: Builder) => void {
    if ((commonMsgInfo.kind == 'CommonMsgInfo_int_msg_info')) {
        return ((builder: Builder) => {
            ...
            builder.storeVarUint(commonMsgInfo.extra_flags, bitLen((16 - 1)));
...
export function storeCommonMsgInfoRelaxed(commonMsgInfoRelaxed: CommonMsgInfoRelaxed): (builder: Builder) => void {
    if ((commonMsgInfoRelaxed.kind == 'CommonMsgInfoRelaxed_int_msg_info')) {
        return ((builder: Builder) => {
            ...
            builder.storeVarUint(commonMsgInfoRelaxed.extra_flags, bitLen((16 - 1)));
...
export function loadEitherStateInit(slice: Slice): EitherStateInit {
    let init: Maybe<Either<StateInit, StateInit>> = loadMaybe<Either<StateInit, StateInit>>(slice, ((slice: Slice) => {
        return loadEither<StateInit, StateInit>(slice, loadStateInit, ((slice: Slice) => {
            let slice1 = slice.loadRef().beginParse(true);
            return loadStateInit(slice1)
    ...
    return {
        kind: 'EitherStateInit',
        init: init,
    }

}

export function storeEitherStateInit(eitherStateInit: EitherStateInit): (builder: Builder) => void {
    return ((builder: Builder) => {
        storeMaybe<Either<StateInit, StateInit>>(eitherStateInit.init, ((arg: Either<StateInit, StateInit>) => {
            return ((builder: Builder) => {
                storeEither<StateInit, StateInit>(arg, storeStateInit, ((arg: StateInit) => {
                    return ((builder: Builder) => {
                        let cell1 = beginCell();
...
export function loadNewBounceOriginalInfo(slice: Slice): NewBounceOriginalInfo {
    let value: CurrencyCollection = loadCurrencyCollection(slice);
    let created_lt: bigint = slice.loadUintBig(64);
    let created_at: number = slice.loadUint(32);
    return {
        kind: 'NewBounceOriginalInfo',
        value: value,
        created_lt: created_lt,
        created_at: created_at,
    }
...
export function storeNewBounceOriginalInfo(newBounceOriginalInfo: NewBounceOriginalInfo): (builder: Builder) => void {
    return ((builder: Builder) => {
        storeCurrencyCollection(newBounceOriginalInfo.value)(builder);
        builder.storeUint(newBounceOriginalInfo.created_lt, 64);
        builder.storeUint(newBounceOriginalInfo.created_at, 32);
    })
...
export function loadNewBounceComputePhaseInfo(slice: Slice): NewBounceComputePhaseInfo {
    let gas_used: number = slice.loadUint(32);
    let vm_steps: number = slice.loadUint(32);
    return {
        kind: 'NewBounceComputePhaseInfo',
        gas_used: gas_used,
        vm_steps: vm_steps,
    }
...
export function storeNewBounceComputePhaseInfo(newBounceComputePhaseInfo: NewBounceComputePhaseInfo): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(newBounceComputePhaseInfo.gas_used, 32);
        builder.storeUint(newBounceComputePhaseInfo.vm_steps, 32);
    })
...
export function loadNewBounceBody(slice: Slice): NewBounceBody {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0xfffffffe))) {
        slice.loadUint(32);
        let slice1 = slice.loadRef().beginParse(true);
        let original_body: Cell = slice1.asCell();
        let slice2 = slice.loadRef().beginParse(true);
        let original_info: NewBounceOriginalInfo = loadNewBounceOriginalInfo(slice2);
        let bounced_by_phase: number = slice.loadUint(8);
        let exit_code: number = slice.loadInt(32);
        let compute_phase: Maybe<NewBounceComputePhaseInfo> = loadMaybe<NewBounceComputePhaseInfo>(slice, loadNewBounceComputePhaseInfo);
        return {
            kind: 'NewBounceBody',
            original_body: original_body,
            original_info: original_info,
            bounced_by_phase: bounced_by_phase,
            exit_code: exit_code,
            compute_phase: compute_phase,
        }

    }
    throw new Error('Expected one of "NewBounceBody" in loading "NewBounceBody", but data does not satisfy any constructor');
}

export function storeNewBounceBody(newBounceBody: NewBounceBody): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0xfffffffe, 32);
        let cell1 = beginCell();
        cell1.storeSlice(newBounceBody.original_body.beginParse(true));
        builder.storeRef(cell1);
        let cell2 = beginCell();
        storeNewBounceOriginalInfo(newBounceBody.original_info)(cell2);
        builder.storeRef(cell2);
        builder.storeUint(newBounceBody.bounced_by_phase, 8);
        builder.storeInt(newBounceBody.exit_code, 32);
        storeMaybe<NewBounceComputePhaseInfo>(newBounceBody.compute_phase, storeNewBounceComputePhaseInfo)(builder);
    })
...
export function loadConfigParam(slice: Slice, arg0: number): ConfigParam {
    ...
    if ((arg0 == 46)) {
        let anon0: ValRegistryConfig = loadValRegistryConfig(slice);
        return {
    ...
    if ((arg0 == 82)) {
        let anon0: JettonBridgeParams = loadJettonBridgeParams(slice);
        return {
            kind: 'ConfigParam__47',
            anon0: anon0,
        }

    }
    throw new Error('Expected one of "ConfigParam__", "ConfigParam__1", "ConfigParam__2", "ConfigParam__3", "ConfigParam__4", "ConfigParam__5", "ConfigParam__6", "ConfigParam__7", "ConfigParam__8", "ConfigParam__9", "ConfigParam__10", "ConfigParam__11", "ConfigParam__12", "ConfigParam__13", "ConfigParam__14", "ConfigParam__15", "ConfigParam__16", "ConfigParam__17", "ConfigParam__18", "ConfigParam__19", "ConfigParam_config_mc_gas_prices", "ConfigParam_config_gas_prices", "ConfigParam_config_mc_block_limits", "ConfigParam_config_block_limits", "ConfigParam_config_mc_fwd_prices", "ConfigParam_config_fwd_prices", "ConfigParam__26", "ConfigParam__27", "ConfigParam__28", "ConfigParam__29", "ConfigParam__30", "ConfigParam__31", "ConfigParam__32", "ConfigParam__33", "ConfigParam__34", "ConfigParam__35", "ConfigParam__36", "ConfigParam__37", "ConfigParam__38", "ConfigParam__39", "ConfigParam__40", "ConfigParam__41", "ConfigParam__42", "ConfigParam__43", "ConfigParam__44", "ConfigParam__45", "ConfigParam__46", "ConfigParam__47" in loading "ConfigParam", but data does not satisfy any constructor');
}
...
export function storeConfigParam(configParam: ConfigParam): (builder: Builder) => void {
    ...
    if ((configParam.kind == 'ConfigParam__41')) {
        return ((builder: Builder) => {
            storeValRegistryConfig(configParam.anon0)(builder);
        })
    ...
    if ((configParam.kind == 'ConfigParam__47')) {
        return ((builder: Builder) => {
            storeJettonBridgeParams(configParam.anon0)(builder);
        })
...
export function loadConfigProposalSetup(slice: Slice): ConfigProposalSetup {
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0x36))) {
        ...
        if ((!(min_tot_rounds <= max_tot_rounds))) {
            throw new Error('Condition (min_tot_rounds <= max_tot_rounds) is not satisfied while loading "ConfigProposalSetup" for type "ConfigProposalSetup"');
        }
        if ((!(min_store_sec <= max_store_sec))) {
            throw new Error('Condition (min_store_sec <= max_store_sec) is not satisfied while loading "ConfigProposalSetup" for type "ConfigProposalSetup"');
        }
        return {
...
export function storeConfigProposalSetup(configProposalSetup: ConfigProposalSetup): (builder: Builder) => void {
    return ((builder: Builder) => {
        ...
        if ((!(configProposalSetup.min_tot_rounds <= configProposalSetup.max_tot_rounds))) {
            throw new Error('Condition (configProposalSetup.min_tot_rounds <= configProposalSetup.max_tot_rounds) is not satisfied while loading "ConfigProposalSetup" for type "ConfigProposalSetup"');
        }
        if ((!(configProposalSetup.min_store_sec <= configProposalSetup.max_store_sec))) {
            throw new Error('Condition (configProposalSetup.min_store_sec <= configProposalSetup.max_store_sec) is not satisfied while loading "ConfigProposalSetup" for type "ConfigProposalSetup"');
        }
    })
...
export function loadWorkchainDescr(slice: Slice): WorkchainDescr {
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0xa6))) {
        ...
        if ((!(min_split <= max_split))) {
            throw new Error('Condition (min_split <= max_split) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"');
        }
        if ((!(max_split <= 60))) {
            throw new Error('Condition (max_split <= 60) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"');
        }
        if ((!(flags == 0))) {
    ...
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0xa7))) {
        ...
        if ((!(min_split <= max_split))) {
            throw new Error('Condition (min_split <= max_split) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"');
        }
        if ((!(max_split <= 60))) {
            throw new Error('Condition (max_split <= 60) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"');
        }
        if ((!(flags == 0))) {
...
export function storeWorkchainDescr(workchainDescr: WorkchainDescr): (builder: Builder) => void {
    if ((workchainDescr.kind == 'WorkchainDescr_workchain')) {
        return ((builder: Builder) => {
            ...
            if ((!(workchainDescr.min_split <= workchainDescr.max_split))) {
                throw new Error('Condition (workchainDescr.min_split <= workchainDescr.max_split) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"');
            }
            if ((!(workchainDescr.max_split <= 60))) {
                throw new Error('Condition (workchainDescr.max_split <= 60) is not satisfied while loading "WorkchainDescr_workchain" for type "WorkchainDescr"');
            }
    ...
    if ((workchainDescr.kind == 'WorkchainDescr_workchain_v2')) {
        return ((builder: Builder) => {
            ...
            if ((!(workchainDescr.min_split <= workchainDescr.max_split))) {
                throw new Error('Condition (workchainDescr.min_split <= workchainDescr.max_split) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"');
            }
            if ((!(workchainDescr.max_split <= 60))) {
                throw new Error('Condition (workchainDescr.max_split <= 60) is not satisfied while loading "WorkchainDescr_workchain_v2" for type "WorkchainDescr"');
            }
            if ((!(workchainDescr.flags == 0))) {
...
export function loadCatchainConfig(slice: Slice): CatchainConfig {
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0xc1))) {
        ...
        if ((!(mc_catchain_lifetime >= 1))) {
            throw new Error('Condition (mc_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
        }
        if ((!(shard_catchain_lifetime >= 1))) {
            throw new Error('Condition (shard_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
        }
        if ((!(shard_validators_lifetime >= 1))) {
            throw new Error('Condition (shard_validators_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
        }
        if ((!(shard_validators_num >= 1))) {
            throw new Error('Condition (shard_validators_num >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
        }
        return {
    ...
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0xc2))) {
        ...
        if ((!(mc_catchain_lifetime >= 1))) {
            throw new Error('Condition (mc_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
        }
        if ((!(shard_catchain_lifetime >= 1))) {
            throw new Error('Condition (shard_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
        }
        if ((!(shard_validators_lifetime >= 1))) {
            throw new Error('Condition (shard_validators_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
        }
        if ((!(shard_validators_num >= 1))) {
            throw new Error('Condition (shard_validators_num >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
        }
        return {
...
export function storeCatchainConfig(catchainConfig: CatchainConfig): (builder: Builder) => void {
    if ((catchainConfig.kind == 'CatchainConfig_catchain_config')) {
        return ((builder: Builder) => {
            ...
            if ((!(catchainConfig.mc_catchain_lifetime >= 1))) {
                throw new Error('Condition (catchainConfig.mc_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
            }
            if ((!(catchainConfig.shard_catchain_lifetime >= 1))) {
                throw new Error('Condition (catchainConfig.shard_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
            }
            if ((!(catchainConfig.shard_validators_lifetime >= 1))) {
                throw new Error('Condition (catchainConfig.shard_validators_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
            }
            if ((!(catchainConfig.shard_validators_num >= 1))) {
                throw new Error('Condition (catchainConfig.shard_validators_num >= 1) is not satisfied while loading "CatchainConfig_catchain_config" for type "CatchainConfig"');
            }
        })
    ...
    if ((catchainConfig.kind == 'CatchainConfig_catchain_config_new')) {
        return ((builder: Builder) => {
            ...
            if ((!(catchainConfig.mc_catchain_lifetime >= 1))) {
                throw new Error('Condition (catchainConfig.mc_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
            }
            if ((!(catchainConfig.shard_catchain_lifetime >= 1))) {
                throw new Error('Condition (catchainConfig.shard_catchain_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
            }
            if ((!(catchainConfig.shard_validators_lifetime >= 1))) {
                throw new Error('Condition (catchainConfig.shard_validators_lifetime >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
            }
            if ((!(catchainConfig.shard_validators_num >= 1))) {
                throw new Error('Condition (catchainConfig.shard_validators_num >= 1) is not satisfied while loading "CatchainConfig_catchain_config_new" for type "CatchainConfig"');
            }
        })
...
export function loadNewConsensusConfig(slice: Slice): NewConsensusConfig {
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0x21))) {
        ...
        if ((!(slots_per_leader_window >= 1))) {
            throw new Error('Condition (slots_per_leader_window >= 1) is not satisfied while loading "NewConsensusConfig_simplex_config" for type "NewConsensusConfig"');
        }
        return {
    ...
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0x22))) {
        slice.loadUint(8);
        let flags: number = slice.loadUint(5);
        let protocol_version: number = slice.loadUint(2);
        let use_quic: Bool = loadBool(slice);
        let slots_per_leader_window: number = slice.loadUint(32);
        ...
        if ((!(slots_per_leader_window >= 1))) {
            throw new Error('Condition (slots_per_leader_window >= 1) is not satisfied while loading "NewConsensusConfig_simplex_config_v2" for type "NewConsensusConfig"');
        }
        return {
...
export function storeNewConsensusConfig(newConsensusConfig: NewConsensusConfig): (builder: Builder) => void {
    if ((newConsensusConfig.kind == 'NewConsensusConfig_simplex_config')) {
        return ((builder: Builder) => {
            ...
            if ((!(newConsensusConfig.slots_per_leader_window >= 1))) {
                throw new Error('Condition (newConsensusConfig.slots_per_leader_window >= 1) is not satisfied while loading "NewConsensusConfig_simplex_config" for type "NewConsensusConfig"');
            }
        })
    ...
    if ((newConsensusConfig.kind == 'NewConsensusConfig_simplex_config_v2')) {
        return ((builder: Builder) => {
            ...
            builder.storeUint(newConsensusConfig.flags, 5);
            builder.storeUint(newConsensusConfig.protocol_version, 2);
            storeBool(newConsensusConfig.use_quic)(builder);
            builder.storeUint(newConsensusConfig.slots_per_leader_window, 32);
            ...
            if ((!(newConsensusConfig.slots_per_leader_window >= 1))) {
                throw new Error('Condition (newConsensusConfig.slots_per_leader_window >= 1) is not satisfied while loading "NewConsensusConfig_simplex_config_v2" for type "NewConsensusConfig"');
            }
        })
...
export function loadSizeLimitsConfig(slice: Slice): SizeLimitsConfig {
    ...
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0x03))) {
        ...
        let max_total_msg_bits: number = slice.loadUint(32);
        let max_total_msg_cells: number = slice.loadUint(32);
        return {
            kind: 'SizeLimitsConfig_size_limits_config_v3',
            max_msg_bits: max_msg_bits,
            max_msg_cells: max_msg_cells,
            max_library_cells: max_library_cells,
            max_vm_data_depth: max_vm_data_depth,
            ...
            acc_state_cells_for_storage_dict: acc_state_cells_for_storage_dict,
            max_transaction_library_loads: max_transaction_library_loads,
            max_total_msg_bits: max_total_msg_bits,
            max_total_msg_cells: max_total_msg_cells,
        }

    }
    throw new Error('Expected one of "SizeLimitsConfig_size_limits_config", "SizeLimitsConfig_size_limits_config_v2", "SizeLimitsConfig_size_limits_config_v3" in loading "SizeLimitsConfig", but data does not satisfy any constructor');
}
...
export function storeSizeLimitsConfig(sizeLimitsConfig: SizeLimitsConfig): (builder: Builder) => void {
    ...
    if ((sizeLimitsConfig.kind == 'SizeLimitsConfig_size_limits_config_v3')) {
        return ((builder: Builder) => {
            builder.storeUint(0x03, 8);
            builder.storeUint(sizeLimitsConfig.max_msg_bits, 32);
            builder.storeUint(sizeLimitsConfig.max_msg_cells, 32);
            ...
            builder.storeUint(sizeLimitsConfig.max_total_msg_bits, 32);
            builder.storeUint(sizeLimitsConfig.max_total_msg_cells, 32);
        })
...
export function loadBlockSignatures(slice: Slice): BlockSignatures {
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0x11))) {
        ...
        return {
            kind: 'BlockSignatures_block_signatures_ordinary',
            validator_list_hash_short: validator_list_hash_short,
            catchain_seqno: catchain_seqno,
            sig_count: sig_count,
    ...
    if (((slice.remainingBits >= 8) && (slice.preloadUint(8) == 0x12))) {
        ...
        let session_id: Buffer = slice.loadBuffer((256 / 8));
        let slot: number = slice.loadUint(32);
        let slice1 = slice.loadRef().beginParse(true);
        let candidate_data: Cell = slice1.asCell();
        return {
            kind: 'BlockSignatures_block_signatures_simplex',
            validator_list_hash_short: validator_list_hash_short,
            catchain_seqno: catchain_seqno,
            sig_count: sig_count,
            sig_weight: sig_weight,
    ...
    throw new Error('Expected one of "BlockSignatures_block_signatures_ordinary", "BlockSignatures_block_signatures_simplex" in loading "BlockSignatures", but data does not satisfy any constructor');
}

export function storeBlockSignatures(blockSignatures: BlockSignatures): (builder: Builder) => void {
    if ((blockSignatures.kind == 'BlockSignatures_block_signatures_ordinary')) {
        return ((builder: Builder) => {
            builder.storeUint(0x11, 8);
            builder.storeUint(blockSignatures.validator_list_hash_short, 32);
            builder.storeUint(blockSignatures.catchain_seqno, 32);
            builder.storeUint(blockSignatures.sig_count, 32);
            builder.storeUint(blockSignatures.sig_weight, 64);
            builder.storeDict(blockSignatures.signatures, Dictionary.Keys.Uint(16), {
                serialize: ((arg: CryptoSignaturePair, builder: Builder) => {
                storeCryptoSignaturePair(arg)(builder);
            }),
                parse: () => { throw new Error('Not implemented') },
    ...
    if ((blockSignatures.kind == 'BlockSignatures_block_signatures_simplex')) {
        return ((builder: Builder) => {
            builder.storeUint(0x12, 8);
            builder.storeUint(blockSignatures.validator_list_hash_short, 32);
            builder.storeUint(blockSignatures.catchain_seqno, 32);
            ...
            builder.storeBuffer(blockSignatures.session_id, (256 / 8));
            builder.storeUint(blockSignatures.slot, 32);
            let cell1 = beginCell();
            cell1.storeSlice(blockSignatures.candidate_data.beginParse(true));
            builder.storeRef(cell1);
        })
...
export function loadAccountStorageDictProof(slice: Slice): AccountStorageDictProof {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x37c1e3fc))) {
        slice.loadUint(32);
        let slice1 = slice.loadRef().beginParse(true);
        let proof: Cell = slice1.asCell();
        return {
            kind: 'AccountStorageDictProof',
            proof: proof,
        }

    }
    throw new Error('Expected one of "AccountStorageDictProof" in loading "AccountStorageDictProof", but data does not satisfy any constructor');
}

export function storeAccountStorageDictProof(accountStorageDictProof: AccountStorageDictProof): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x37c1e3fc, 32);
        let cell1 = beginCell();
        cell1.storeSlice(accountStorageDictProof.proof.beginParse(true));
        builder.storeRef(cell1);
    })
...
export function loadConsensusExtraData(slice: Slice): ConsensusExtraData {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x638eb292))) {
        slice.loadUint(32);
        let flags: number = slice.loadUint(32);
        let gen_utime_ms: bigint = slice.loadUintBig(64);
        return {
            kind: 'ConsensusExtraData',
            flags: flags,
            gen_utime_ms: gen_utime_ms,
        }

    }
    throw new Error('Expected one of "ConsensusExtraData" in loading "ConsensusExtraData", but data does not satisfy any constructor');
}

export function storeConsensusExtraData(consensusExtraData: ConsensusExtraData): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x638eb292, 32);
        builder.storeUint(consensusExtraData.flags, 32);
        builder.storeUint(consensusExtraData.gen_utime_ms, 64);
    })
...
export function loadValRegistryConfig(slice: Slice): ValRegistryConfig {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x3601163e))) {
        slice.loadUint(32);
        let contract_address: Buffer = slice.loadBuffer((256 / 8));
        let max_collators_per_validator: number = slice.loadUint(32);
        let new_code_hash: Maybe<bigint> = loadMaybe<bigint>(slice, ((slice: Slice) => {
            return slice.loadUintBig(256)
        ...
        return {
            ...
            max_collators_per_validator: max_collators_per_validator,
            new_code_hash: new_code_hash,
        }

    }
    throw new Error('Expected one of "ValRegistryConfig" in loading "ValRegistryConfig", but data does not satisfy any constructor');
}

export function storeValRegistryConfig(valRegistryConfig: ValRegistryConfig): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x3601163e, 32);
        builder.storeBuffer(valRegistryConfig.contract_address, (256 / 8));
        builder.storeUint(valRegistryConfig.max_collators_per_validator, 32);
        storeMaybe<bigint>(valRegistryConfig.new_code_hash, ((arg: bigint) => {
            return ((builder: Builder) => {
                builder.storeUint(arg, 256);
            })
...
export function loadBitsPow2(slice: Slice, arg0: number): BitsPow2 {
    if ((arg0 == 0)) {
    ...
    if (true) {
        let l: BitsPow2 = loadBitsPow2(slice, (arg0 - 1));
        let r: BitsPow2 = loadBitsPow2(slice, (arg0 - 1));
        return {
            kind: 'BitsPow2__1',
            n: (arg0 - 1),
            l: l,
    ...
    throw new Error('Expected one of "BitsPow2__", "BitsPow2__1" in loading "BitsPow2", but data does not satisfy any constructor');
}

export function storeBitsPow2(bitsPow2: BitsPow2): (builder: Builder) => void {
    if ((bitsPow2.kind == 'BitsPow2__')) {
        return ((builder: Builder) => {
            builder.storeUint(bitsPow2.x, 1);
        })

    }
    if ((bitsPow2.kind == 'BitsPow2__1')) {
        return ((builder: Builder) => {
            storeBitsPow2(bitsPow2.l)(builder);
            storeBitsPow2(bitsPow2.r)(builder);
        })
...
export function loadValRegistryShardSet(slice: Slice): ValRegistryShardSet {
    let n: number = slice.loadUint(bitLen(8));
    let mask: BitsPow2 = loadBitsPow2(slice, n);
    return {
        kind: 'ValRegistryShardSet',
        n: n,
        mask: mask,
    }
...
export function storeValRegistryShardSet(valRegistryShardSet: ValRegistryShardSet): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(valRegistryShardSet.n, bitLen(8));
        storeBitsPow2(valRegistryShardSet.mask)(builder);
    })
...
export function loadValRegistryStorage(slice: Slice): ValRegistryStorage {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x9bc722a8))) {
        slice.loadUint(32);
        let registry: Dictionary<bigint, ValRegistryValidator> = Dictionary.load(Dictionary.Keys.BigUint(256), {
            serialize: () => { throw new Error('Not implemented') },
            parse: loadValRegistryValidator,
        }, slice);
        let last_cleanup_key_block_seqno: number = slice.loadUint(32);
        return {
            kind: 'ValRegistryStorage',
            registry: registry,
            last_cleanup_key_block_seqno: last_cleanup_key_block_seqno,
        }

    }
    throw new Error('Expected one of "ValRegistryStorage" in loading "ValRegistryStorage", but data does not satisfy any constructor');
}

export function storeValRegistryStorage(valRegistryStorage: ValRegistryStorage): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x9bc722a8, 32);
        builder.storeDict(valRegistryStorage.registry, Dictionary.Keys.BigUint(256), {
            serialize: ((arg: ValRegistryValidator, builder: Builder) => {
            storeValRegistryValidator(arg)(builder);
        }),
            parse: () => { throw new Error('Not implemented') },
        });
        builder.storeUint(valRegistryStorage.last_cleanup_key_block_seqno, 32);
    })
...
export function loadValRegistryValidator(slice: Slice): ValRegistryValidator {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x57766eec))) {
        slice.loadUint(32);
        let allow_update_at: number = slice.loadUint(32);
        let entry: Maybe<ValRegistryEntry> = loadMaybe<ValRegistryEntry>(slice, ((slice: Slice) => {
            let slice1 = slice.loadRef().beginParse(true);
            return loadValRegistryEntry(slice1)

        }));
        return {
            kind: 'ValRegistryValidator',
            allow_update_at: allow_update_at,
            entry: entry,
        }

    }
    throw new Error('Expected one of "ValRegistryValidator" in loading "ValRegistryValidator", but data does not satisfy any constructor');
}

export function storeValRegistryValidator(valRegistryValidator: ValRegistryValidator): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x57766eec, 32);
        builder.storeUint(valRegistryValidator.allow_update_at, 32);
        storeMaybe<ValRegistryEntry>(valRegistryValidator.entry, ((arg: ValRegistryEntry) => {
            return ((builder: Builder) => {
                let cell1 = beginCell();
                storeValRegistryEntry(arg)(cell1);
                builder.storeRef(cell1);
...
export function loadValRegistryEntry(slice: Slice): ValRegistryEntry {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0xeae0b274))) {
        slice.loadUint(32);
        let collators: Dictionary<bigint, ValRegistryCollator> = Dictionary.load(Dictionary.Keys.BigUint(256), {
            serialize: () => { throw new Error('Not implemented') },
            parse: loadValRegistryCollator,
        }, slice);
        let monitoring_shards: ValRegistryShardSet = loadValRegistryShardSet(slice);
        return {
            kind: 'ValRegistryEntry',
            collators: collators,
            monitoring_shards: monitoring_shards,
        }

    }
    throw new Error('Expected one of "ValRegistryEntry" in loading "ValRegistryEntry", but data does not satisfy any constructor');
}

export function storeValRegistryEntry(valRegistryEntry: ValRegistryEntry): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0xeae0b274, 32);
        builder.storeDict(valRegistryEntry.collators, Dictionary.Keys.BigUint(256), {
            serialize: ((arg: ValRegistryCollator, builder: Builder) => {
            storeValRegistryCollator(arg)(builder);
        }),
            parse: () => { throw new Error('Not implemented') },
        });
        storeValRegistryShardSet(valRegistryEntry.monitoring_shards)(builder);
    })
...
export function loadValRegistryCollator(slice: Slice): ValRegistryCollator {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x10364494))) {
        slice.loadUint(32);
        let monitoring_shards: ValRegistryShardSet = loadValRegistryShardSet(slice);
        return {
            kind: 'ValRegistryCollator',
            monitoring_shards: monitoring_shards,
        }

    }
    throw new Error('Expected one of "ValRegistryCollator" in loading "ValRegistryCollator", but data does not satisfy any constructor');
}

export function storeValRegistryCollator(valRegistryCollator: ValRegistryCollator): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x10364494, 32);
        storeValRegistryShardSet(valRegistryCollator.monitoring_shards)(builder);
    })
...
export function loadValRegistryMessageRequest(slice: Slice): ValRegistryMessageRequest {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0xcdb9d286))) {
        slice.loadUint(32);
        let signature: Array<boolean> = Array.from(Array(512).keys()).map(((arg: number) => {
            return slice.loadBit()

        }));
        let request: ValRegistryRequest = loadValRegistryRequest(slice);
        return {
            kind: 'ValRegistryMessageRequest',
            signature: signature,
            request: request,
        }

    }
    throw new Error('Expected one of "ValRegistryMessageRequest" in loading "ValRegistryMessageRequest", but data does not satisfy any constructor');
}

export function storeValRegistryMessageRequest(valRegistryMessageRequest: ValRegistryMessageRequest): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0xcdb9d286, 32);
        valRegistryMessageRequest.signature.forEach(((arg: boolean) => {
            builder.storeBit(arg);
        }));
        storeValRegistryRequest(valRegistryMessageRequest.request)(builder);
    })
...
export function loadValRegistryRequest(slice: Slice): ValRegistryRequest {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0xfbd82b02))) {
        slice.loadUint(32);
        let last_key_block_seqno: number = slice.loadUint(32);
        let val_set: number = slice.loadUint(8);
        let val_idx: number = slice.loadUint(16);
        let valid_until: number = slice.loadUint(32);
        let new_entry: Maybe<ValRegistryEntry> = loadMaybe<ValRegistryEntry>(slice, ((slice: Slice) => {
            let slice1 = slice.loadRef().beginParse(true);
            return loadValRegistryEntry(slice1)

        }));
        return {
            kind: 'ValRegistryRequest',
            last_key_block_seqno: last_key_block_seqno,
            val_set: val_set,
            val_idx: val_idx,
            valid_until: valid_until,
            new_entry: new_entry,
    ...
    throw new Error('Expected one of "ValRegistryRequest" in loading "ValRegistryRequest", but data does not satisfy any constructor');
}

export function storeValRegistryRequest(valRegistryRequest: ValRegistryRequest): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0xfbd82b02, 32);
        builder.storeUint(valRegistryRequest.last_key_block_seqno, 32);
        builder.storeUint(valRegistryRequest.val_set, 8);
        builder.storeUint(valRegistryRequest.val_idx, 16);
        builder.storeUint(valRegistryRequest.valid_until, 32);
        storeMaybe<ValRegistryEntry>(valRegistryRequest.new_entry, ((arg: ValRegistryEntry) => {
            return ((builder: Builder) => {
                let cell1 = beginCell();
                storeValRegistryEntry(arg)(cell1);
                builder.storeRef(cell1);
...
export function loadValRegistryMessageCleanup(slice: Slice): ValRegistryMessageCleanup {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x32b85a9b))) {
        slice.loadUint(32);
        return {
            kind: 'ValRegistryMessageCleanup',
        }

    }
    throw new Error('Expected one of "ValRegistryMessageCleanup" in loading "ValRegistryMessageCleanup", but data does not satisfy any constructor');
}

export function storeValRegistryMessageCleanup(valRegistryMessageCleanup: ValRegistryMessageCleanup): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x32b85a9b, 32);
    })
...
export function loadValRegistryMessageUpdateCode(slice: Slice): ValRegistryMessageUpdateCode {
    if (((slice.remainingBits >= 32) && (slice.preloadUint(32) == 0x34bdaa6c))) {
        slice.loadUint(32);
        let slice1 = slice.loadRef().beginParse(true);
        let new_code: Cell = slice1.asCell();
        return {
            kind: 'ValRegistryMessageUpdateCode',
            new_code: new_code,
        }

    }
    throw new Error('Expected one of "ValRegistryMessageUpdateCode" in loading "ValRegistryMessageUpdateCode", but data does not satisfy any constructor');
}

export function storeValRegistryMessageUpdateCode(valRegistryMessageUpdateCode: ValRegistryMessageUpdateCode): (builder: Builder) => void {
    return ((builder: Builder) => {
        builder.storeUint(0x34bdaa6c, 32);
        let cell1 = beginCell();
        cell1.storeSlice(valRegistryMessageUpdateCode.new_code.beginParse(true));
        builder.storeRef(cell1);
    })
